(() => {
    ...
    function bn(e) {
        V.includes(e) || V.push(e), vn()
    }

    function ye(e) {
        let t = V.indexOf(e);
        t !== -1 && t > Ze && V.splice(t, 1)
    }

    function vn() {
        !Xe && !Ye && (Ye = !0, queueMicrotask(wn))
    }

    function wn() {
        Ye = !1, Xe = !0;
        for (let e = 0; e < V.length; e++) V[e](), Ze = e;
        V.length = 0, Ze = -1, Xe = !1
    }
    ...
    function zt(e) {
        C = e.reactive, $ = e.release, P = t => e.effect(t, {
            scheduler: r => {
                et ? Bt(r) : r()
            }
        }), Qe = e.raw
    ...
    var it = new MutationObserver(nt), ot = !1;
    ...
    function st() {
        En(), it.disconnect(), ot = !1
    }

    var ae = [], at = !1;

    function En() {
        ae = ae.concat(it.takeRecords()), ae.length && !at && (at = !0, queueMicrotask(() => {
            Sn(), at = !1
        }))
    }
    ...
    function Se(e, t = () => {
        ...
        let r = {
            initialValue: void 0, _x_interceptor: !0, initialize(n, i, o) {
                return e(this.initialValue, () => An(n, i), s => lt(n, i, s), i, o)
            }
        };
        return t(r), n => {
...
` : ""}`, t), setTimeout(() => {
    ...
    function ft(e, t) {
        let r = {};
        ce(r, e);
        let n = [r, ...L(e)], i = typeof t == "function" ? On(n, t) : Tn(n, t, e);
    ...
    function le(e, t, r) {
        ...
        let n = {};
        return t.map(ir((o, s) => n[o] = s)).filter(or).map(Mn(n, r)).sort(Nn).map(o => Rn(e, o))
    }
    ...
    function Rn(e, t) {
        ...
        Jt(e, t.original, o);
        let s = () => {
            e._x_ignore || e._x_ignoreSelf || (n.inline && n.inline(e, t, i), n = n.bind(n, e, t, i), _t ? ue.get(sr).push(n) : n())
        };
        return s.runCleanups = o, s
    }

    var Te = (e, t) => ({name: r, value: n}) => (r.startsWith(e) && (r = r.replace(e, t)), {name: r, value: n}),
        Ce = e => e;
    ...
    var lr = () => new RegExp(`^${pt}([^:^.]+)\\b`);

    function Mn(e, t) {
        return ({name: r, value: n}) => {
            let i = r.match(lr()), o = r.match(/:([a-zA-Z0-9\-:]+)/), s = r.match(/\.[^.\]]+(?=[^\]]*$)/g) || [],
                a = t || e[r] || r;
            return {
                type: i ? i[1] : null,
                value: o ? o[1] : null,
    ...
    var gt = "DEFAULT",
        H = ["ignore", "ref", "data", "id", "bind", "init", "for", "model", "modelable", "transition", "show", "if", gt, "teleport"];
    ...
    function fe(e, t) {
        return Array.isArray(t) ? yr(e, t.join(" ")) : typeof t == "object" && t !== null ? In(e, t) : typeof t == "function" ? fe(e, t()) : yr(e, t)
    }
    ...
    function W(e, t) {
        return typeof t == "object" && t !== null ? Pn(e, t) : Dn(e, t)
    }
    ...
    p("transition", (e, {value: t, modifiers: r, expression: n}, {evaluate: i}) => {
        typeof n == "function" && (n = i(n)), n !== !1 && (!n || typeof n == "boolean" ? Ln(e, r, t) : $n(e, n, t))
    });
    ...
    function Ln(e, t, r) {
        ...
        let s = !t.includes("opacity") && !t.includes("scale"), a = s || t.includes("opacity"),
            c = s || t.includes("scale"), l = a ? 0 : 1, u = c ? pe(t, "scale", 95) / 100 : 1,
            d = pe(t, "delay", 0) / 1e3, m = pe(t, "origin", "center"), v = "opacity, transform",
            k = pe(t, "duration", 150) / 1e3, xe = pe(t, "duration", 75) / 1e3, f = "cubic-bezier(0.4, 0.0, 0.2, 1)";
    ...
    function br(e, t, r = {}) {
        e._x_transition || (e._x_transition = {
            ...
            in(n = () => {
                ...
                Ie(e, t, {during: this.enter.during, start: this.enter.start, end: this.enter.end}, n, i)
            },
            out(n = () => {
            }, i = () => {
            }) {
                Ie(e, t, {during: this.leave.during, start: this.leave.start, end: this.leave.end}, n, i)
            }
        })
    }
    ...
    function Er(e, t) {
        t._x_dataStack || (t._x_dataStack = e._x_dataStack), te = !0, Bn(() => {
            jn(t)
        }), te = !1
    }
    ...
    function me(e, t, r, n = []) {
        switch (e._x_bindings || (e._x_bindings = C({})), e._x_bindings[t] = r, t = n.includes("camel") ? qn(t) : t, t) {
            case "value":
                Kn(e, r);
                break;
            case "style":
    ...
    function Kn(e, t) {
        if (e.type === "radio") e.attributes.value === void 0 && (e.value = t), window.fromModel && (e.checked = Ar(e.value, t)); else if (e.type === "checkbox") Number.isInteger(t) ? e.value = t : !Number.isInteger(t) && !Array.isArray(t) && typeof t != "boolean" && ![null, void 0].includes(t) ? e.value = String(t) : Array.isArray(t) ? e.checked = t.some(r => Ar(r, e.value)) : e.checked = !!t; else if (e.tagName === "SELECT") Un(e, t); else {
            if (e.value === t) return;
            e.value = t
        }
    }
    ...
    function Sr(e, t, r) {
        [null, void 0, !1].includes(r) && Jn(t) ? e.removeAttribute(t) : (Or(t) && (r = t), Gn(e, t, r))
    }
    ...
    function Mr(e, t) {
        if (Rr || (G = C(G), Rr = !0), t === void 0) return G[e];
        G[e] = t, typeof t == "object" && t !== null && t.hasOwnProperty("init") && typeof t.init == "function" && G[e].init(), Ee(G[e])
    }
    ...
    function Pr(e, t) {
        ...
        e instanceof Element ? wt(e, r()) : Ir[e] = r
    }

    function Dr(e) {
        return Object.entries(Ir).forEach(([t, r]) => {
    ...
    var Yn = {
        ...
        version: "3.12.2",
        flushAndStopDeferringMutations: Xt,
    ...
    var Xn = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly";
    var gs = Et(Xn + ",async,autofocus,autoplay,controls,default,defer,disabled,hidden,loop,open,required,reversed,scoped,seamless,checked,muted,multiple,selected");
    var Fr = Object.freeze({}), xs = Object.freeze([]);
    var St = Object.assign;
    var Zn = Object.prototype.hasOwnProperty, he = (e, t) => Zn.call(e, t), B = Array.isArray,
        re = e => jr(e) === "[object Map]";
    var Qn = e => typeof e == "string", ke = e => typeof e == "symbol", _e = e => e !== null && typeof e == "object";
    var ei = Object.prototype.toString, jr = e => ei.call(e), At = e => jr(e).slice(8, -1);
    var $e = e => Qn(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e;
    var Le = e => {
            let t = Object.create(null);
            return r => t[r] || (t[r] = e(r))
        }, ti = /-(\w)/g, ys = Le(e => e.replace(ti, (t, r) => r ? r.toUpperCase() : "")), ri = /\B([A-Z])/g,
        bs = Le(e => e.replace(ri, "-$1").toLowerCase()), Ot = Le(e => e.charAt(0).toUpperCase() + e.slice(1)),
        vs = Le(e => e ? `on${Ot(e)}` : ""), Tt = (e, t) => e !== t && (e === e || t === t);
    var Ct = new WeakMap, ge = [], I, J = Symbol("iterate"), Rt = Symbol("Map key iterate");
    ...
    function ii(e, t) {
        let r = function () {
            ...
            if (!ge.includes(r)) {
                Kr(r);
                try {
                    return si(), ge.push(r), I = r, e()
                } finally {
                    ge.pop(), Vr(), I = ge[ge.length - 1]
                }
            }
        };
        return r.id = oi++, r.allowRecurse = !!t.allowRecurse, r._isEffect = !0, r.active = !0, r.raw = e, r.deps = [], r.options = t, r
    }
    ...
    function K(e, t, r, n, i, o) {
        ...
        if (t === "clear") s.forEach(c); else if (r === "length" && B(e)) s.forEach((u, d) => {
            ...
            case "add":
                B(e) ? $e(r) && c(s.get("length")) : (c(s.get(J)), re(e) && c(s.get(Rt)));
                break;
            case "delete":
    ...
    var ci = Et("__proto__,__v_isRef,__isVue"),
        Hr = new Set(Object.getOwnPropertyNames(Symbol).map(e => Symbol[e]).filter(ke)), li = Fe(), ui = Fe(!1, !0),
        fi = Fe(!0), di = Fe(!0, !0), je = {};
    ...
    function Fe(e = !1, t = !1) {
        return function (n, i, o) {
            ...
            if (i === "__v_raw" && o === (e ? t ? mi : Ur : t ? pi : qr).get(n)) return n;
            let s = B(n);
            if (!e && s && he(je, i)) return Reflect.get(je, i, o);
            let a = Reflect.get(n, i, o);
            return (ke(i) ? Hr.has(i) : ci(i)) || (e || R(n, "get", i), t) ? a : Nt(a) ? !s || !$e(i) ? a.value : a : _e(a) ? e ? Wr(a) : Be(a) : a
        }
    }
    ...
    function Gr(e = !1) {
        return function (r, n, i, o) {
            ...
            let a = B(r) && $e(n) ? Number(n) < r.length : he(r, n), c = Reflect.set(r, n, i, o);
    ...
    function xi(e, t) {
        ...
        return (!ke(t) || !Hr.has(t)) && R(e, "has", t), r
    }
    ...
    var Jr = {get: li, set: hi, deleteProperty: gi, has: xi, ownKeys: yi}, Yr = {
            get: fi, set(e, t) {
                return console.warn(`Set operation on key "${String(t)}" failed: target is readonly.`, e), !0
            }, deleteProperty(e, t) {
                return console.warn(`Delete operation on key "${String(t)}" failed: target is readonly.`, e), !0
            }
        }, Ts = St({}, Jr, {get: ui, set: _i}), Cs = St({}, Yr, {get: di}), It = e => _e(e) ? Be(e) : e,
        Pt = e => _e(e) ? Wr(e) : e, Dt = e => e, Ke = e => Reflect.getPrototypeOf(e);

    function ze(e, t, r = !1, n = !1) {
        e = e.__v_raw;
        let i = g(e), o = g(t);
        t !== o && !r && R(i, "get", t), !r && R(i, "get", o);
        let {has: s} = Ke(i), a = n ? Dt : r ? Pt : It;
    ...
    function en(e) {
        ...
        i ? Zr(t, r, e) : (e = g(e), i = r.call(t, e));
        let o = n ? n.call(t, e) : void 0, s = t.delete(e);
        return i && K(t, "delete", e, void 0, o), s
    }

    function tn() {
        let e = g(this), t = e.size !== 0, r = re(e) ? new Map(e) : new Set(e), n = e.clear();
        return t && K(e, "clear", void 0, void 0, r), n
    }

    function qe(e, t) {
        return function (n, i) {
            let o = this, s = o.__v_raw, a = g(s), c = t ? Dt : e ? Pt : It;
    ...
    function Ue(e, t, r) {
        return function (...n) {
            let i = this.__v_raw, o = g(i), s = re(o), a = e === "entries" || e === Symbol.iterator && s,
                c = e === "keys" && s, l = i[e](...n), u = r ? Dt : t ? Pt : It;
    ...
    var rn = {
        get(e) {
            ...
            return He(this)
        }, has: Ve, add: Xr, set: Qr, delete: en, clear: tn, forEach: qe(!1, !1)
    }, nn = {
        get(e) {
            return ze(this, e, !1, !0)
        }, get size() {
            return He(this)
        }, has: Ve, add: Xr, set: Qr, delete: en, clear: tn, forEach: qe(!1, !0)
    }, on = {
        get(e) {
            return ze(this, e, !0)
        }, get size() {
    ...
    }, bi = ["keys", "values", "entries", Symbol.iterator];
    bi.forEach(e => {
        rn[e] = Ue(e, !1, !1), on[e] = Ue(e, !0, !1), nn[e] = Ue(e, !1, !0), sn[e] = Ue(e, !0, !0)
    });

    function We(e, t) {
        let r = t ? e ? sn : nn : e ? on : rn;
        return (n, i, o) => i === "__v_isReactive" ? !e : i === "__v_isReadonly" ? e : i === "__v_raw" ? n : Reflect.get(he(r, i) && i in n ? r : n, i, o)
    }

    var vi = {get: We(!1, !1)}, Rs = {get: We(!1, !0)}, wi = {get: We(!0, !1)}, Ms = {get: We(!0, !0)};
    ...
    var qr = new WeakMap, pi = new WeakMap, Ur = new WeakMap, mi = new WeakMap;
    ...
    function Si(e) {
        return e.__v_skip || !Object.isExtensible(e) ? 0 : Ei(At(e))
    }

    function Be(e) {
        return e && e.__v_isReadonly ? e : an(e, !1, Jr, vi, qr)
    }

    function Wr(e) {
        return an(e, !0, Yr, wi, Ur)
    }
    ...
    y("data", e => we(e));
    y("root", e => U(e));
    y("refs", e => (e._x_refs_proxy || (e._x_refs_proxy = F(Ai(e))), e._x_refs_proxy));
    ...
    y("id", e => (t, r = null) => {
        let n = cn(e, t), i = n ? n._x_ids[t] : $t(t);
        return r ? `${t}-${i}-${r}` : `${t}-${i}`
    });
    y("el", e => e);
    ...
    function fn({get: e, set: t}, {get: r, set: n}) {
        let i = !0, o, s, a, c, l = P(() => {
            let u, d;
    ...
    p("modelable", (e, {expression: t}, {effect: r, evaluateLater: n, cleanup: i}) => {
        ...
        c(l), queueMicrotask(() => {
            ...
            let u = e._x_model.get, d = e._x_model.set, m = fn({
                get() {
                    return u()
                }, set(v) {
                    d(v)
    ...
    p("teleport", (e, {modifiers: t, expression: r}, {cleanup: n}) => {
        ...
        let i = N(() => document.querySelector(r), () => Oi)();
    ...
    function ie(e, t, r, n) {
        ...
        if (r.includes("dot") && (t = Ti(t)), r.includes("camel") && (t = Ci(t)), r.includes("passive") && (s.passive = !0), r.includes("capture") && (s.capture = !0), r.includes("window") && (i = window), r.includes("document") && (i = document), r.includes("debounce")) {
    ...
    p("model", (e, {modifiers: t, expression: r}, {effect: n, cleanup: i}) => {
        ...
        let c = () => {
            let m;
            return s(v => m = v), mn(m) ? m.get() : m
        }, l = m => {
            let v;
            s(k => v = k), mn(v) ? v.set(m) : a(() => {
        ...
        if (t.includes("fill") && [null, ""].includes(c()) && e.dispatchEvent(new Event(u, {})), e._x_removeModelListeners || (e._x_removeModelListeners = {}), e._x_removeModelListeners.default = d, i(() => e._x_removeModelListeners.default()), e.form) {
    ...
    p("for", (e, {expression: t}, {effect: r, cleanup: n}) => {
        let i = Li(t), o = x(e, i.items), s = x(e, e._x_keyExpression || "index");
    ...
    function $i(e, t, r, n) {
        ...
        r(s => {
            Fi(s) && s >= 0 && (s = Array.from(Array(s).keys(), f => f + 1)), s === void 0 && (s = []);
            ...
            for (let f = 0; f < u.length; f++) {
                ...
                if (b === -1) c.splice(f, 0, _), d.push([xe, f]); else if (b !== f) {
                    let w = c.splice(f, 1)[0], A = c.splice(b - 1, 1)[0];
            ...
            for (let f = 0; f < m.length; f++) {
                let [_, b] = m[f], w = a[_], A = a[b], Y = document.createElement("div");
                h(() => {
                    A || S('x-for ":key" is undefined or invalid', o), A.after(Y), w.after(A), A._x_currentIfEl && A.after(A._x_currentIfEl), Y.before(w), w._x_currentIfEl && w.after(w._x_currentIfEl), Y.remove()
                }), A._x_refreshXForScope(l[u.indexOf(b)])
            }
            for (let f = 0; f < d.length; f++) {
                let [_, b] = d[f], w = _ === "template" ? o : a[_];
                w._x_currentIfEl && (w = w._x_currentIfEl);
                let A = l[b], Y = u[b], oe = document.importNode(o.content, !0).firstElementChild, jt = C(A);
                M(oe, jt, o), oe._x_refreshXForScope = gn => {
    ...
    j.setEvaluator(ft);
    j.setReactivityEngine({reactive: Be, effect: Br, release: zr, raw: g});
    var Ft = j;
    window.Alpine = Ft;
    queueMicrotask(() => {
        Ft.start()
